...
(function(){
  ...
  if(legend){const n=document.createElement('div');n.className='legend';n.innerHTML='<b>✅ Check mercato 02/09:</b> lista riallineata dopo la chiusura del mercato. Rimossi i giocatori usciti e aggiunti i principali ingressi mancanti.';legend.parentNode.insertBefore(n,legend);}
})();
